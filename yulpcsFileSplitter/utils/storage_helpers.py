...
def insert_review(business_id, state_code, business, reviews, sql_connection_string): 
    try:
        # Connection string
        ...
        params = (-1, business_id, state_code, 0, 0, json.dumps(business), json.dumps(reviews))
